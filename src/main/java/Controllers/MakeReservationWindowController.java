...
public class MakeReservationWindowController implements Initializable {
    ...
    private void initializeData() {
        ...
        Room roomA = new Room("Room A", 50, false, "A", "Sala", new ArrayList<>(Arrays.asList(deskA1, tableA1, chairA1)));

        // Room B
        Space deskB1 = new Desk("DskB1", "Desk B1", 4, false);
        Space chairB1 = new Chair("ChrB1", "Chair B1", 1, true);
        Room roomB = new Room("Room B", 40, false, "B", "Sala", new ArrayList<>(Arrays.asList(deskB1, chairB1)));
        ...
        Room roomC = new Room("Room C", 60, false, "C", "Sala", new ArrayList<>(Arrays.asList(tableC1, chairC1, chairC2)));
        ...
        Room roomD = new Room("Room D", 55, false, "D", "Sala", new ArrayList<>(Arrays.asList(deskD1, tableD1)));
        ...
        Room roomE = new Room("Room E", 45, false, "E", "Sala", new ArrayList<>(Arrays.asList(chairE1, tableE1, chairE2)));

        floor2Rooms = new ArrayList<>(Arrays.asList(roomD, roomE));

        Space deskF1 = new Desk("DskF1", "Desk F1", 4, false);
        Room roomF = new Room("Room F", 70, false, "F", "Sala", new ArrayList<>(Arrays.asList(deskF1)));

        // Room G
        Space chairG1 = new Chair("ChrG1", "Chair G1", 1, false);
        Space deskG1 = new Desk("DskG1", "Desk G1", 4, true);
        Room roomG = new Room("Room G", 65, false, "G", "Sala", new ArrayList<>(Arrays.asList(chairG1, deskG1)));
